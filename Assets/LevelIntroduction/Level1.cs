...
public class Level1 : LevelSetup {
	...
	public List<Action> Setup()
	{
		...
		actions.Add(new TextAction(4, "Walk into the light-turret. Rotate left and right to see into the maze."));
		...
		actions.Add(new MoveCameraAction("Lighthouse"));
		actions.Add(new TextAction(4, "Hold down your trigger for 1 second to exit the light-turret."));
