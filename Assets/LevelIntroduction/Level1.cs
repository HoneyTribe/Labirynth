...
public class Level1 : LevelSetup {
	...
	public List<Action> Setup()
	{
		...
		actions.Add(new TextAction(2, "When all the energy is collected everyone needs to high-five to time jump."));
		actions.Add(new MoveCameraAction("Lighthouse"));
		actions.Add(new TextAction(3, "Hold down your trigger for 1 second to exit the light-turret."));
