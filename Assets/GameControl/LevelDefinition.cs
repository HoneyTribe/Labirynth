...
namespace AssemblyCSharp
{
		public class LevelDefinition
		{
				...
				public LevelDefinition ()
				{
					...
					//8
					levels2.Add(new Level(new MachineCreator(true, false, true, false, true, false),
					...
					//11
					levels2.Add(new Level(new MachineCreator(true, false, true, true, true, false),
					...
					//12
					levels2.Add(new Level(new MachineCreator(true, false, true, true, true, true),
						10,new List<MonsterTemplate>{
						new MonsterTemplate("Flying", 3.0f),
						new MonsterTemplate("Flying", 3.0f),
						new MonsterTemplate("Flying", 3.0f)
					...
					//8
					levels3.Add(new Level(new MachineCreator(true, false, true, false, true, false),
						9,new List<MonsterTemplate>{
					},5,5,7,7, null, "CranePuzzle"));
					//9
					levels3.Add(new Level(new MachineCreator(true, false, true, false, true, false),
					...
					//11
					levels3.Add(new Level(new MachineCreator(true, false, true, true, true, false),
						15,new List<MonsterTemplate>{
					...
					//12
					levels3.Add(new Level(new MachineCreator(true, false, true, true, true, true),
						10,new List<MonsterTemplate>{
						new MonsterTemplate("Flying", 3.2f),
						new MonsterTemplate("Flying", 3.2f),
						new MonsterTemplate("Flying", 3.2f)
					...
					//8
					levels4.Add(new Level(new MachineCreator(true, false, true, false, true, false),
						9,new List<MonsterTemplate>{
					},5,5,7,7, null, "CranePuzzle"));
					//9
					levels4.Add(new Level(new MachineCreator(true, false, true, false, true, false),
					...
					//11
					levels4.Add(new Level(new MachineCreator(true, false, true, true, true, false),
					...
					//12
					levels4.Add(new Level(new MachineCreator(true, false, true, true, true, true),
